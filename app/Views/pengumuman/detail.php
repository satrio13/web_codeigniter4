...
<section id="isi" class="pt-3 pb-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 text-break">
                <div class="row">
                    <?php if($data->gambar != '' AND file_exists("uploads/img/pengumuman/$data->gambar")){ ?>
                        <div class="col-md-12">
                            <a href="<?= base_url("uploads/img/pengumuman/$data->gambar"); ?>" class="image-link">
                                <img src="<?= base_url("uploads/img/pengumuman/$data->gambar"); ?>" class="img img-fluid">
                            </a>
                        </div>
                    <?php } ?>
                    <div class="col-md-12">

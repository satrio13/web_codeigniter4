...
<section id="isi" class="pt-3 pb-5">
        ...
        <div class="row">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-white">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('ekstrakurikuler'); ?>">Ekstrakurikuler</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 text-break">
                <div class="row">
                    <?php if($data->gambar != '' AND file_exists("uploads/img/ekstrakurikuler/$data->gambar")){ ?>
                        <div class="col-md-12">
                            <a href="<?= base_url("uploads/img/ekstrakurikuler/$data->gambar"); ?>" class="image-link">
                                <img src="<?= base_url("uploads/img/ekstrakurikuler/$data->gambar"); ?>" class="img img-fluid">
                            </a>
                        </div>
                    <?php } ?>
                    <div class="col-md-12">

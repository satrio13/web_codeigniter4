                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('backend/tambah-prestasi-guru'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Prestasi Guru</a>
                            ...
                            <div class="table table-responsive">
                                <table class="table table-bordered table-striped table-sm" id="datatable">
                                    ...
                                    foreach($data as $r):
                                        ...
                                        $target = "uploads/img/prestasi/guru/$r->gambar";
                                        if($r->gambar != '' AND file_exists($target))
                                        {
                                            $img = '<a href="'.base_url("uploads/img/prestasi/guru/$r->gambar").'" target="_blank">
                                                        <img src="'.base_url("uploads/img/prestasi/guru/$r->gambar").'" class="img img-fluid" width="100px">
                                                    </a>'; 
                                        }else
                                        {
                                            $img = '';
                                        ...
                                        echo'<tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="'.base_url("backend/hapus-prestasi-guru/$r->id").'" title="HAPUS DATA">HAPUS</a>
                                                </td>
                                            </tr>';
                                    endforeach;
                                    ?>

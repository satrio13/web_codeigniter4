            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart('backend/simpan-prestasi-guru','id="form"'); ?>
                        <?= csrf_field(); ?>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nama_guru" maxlength="100" value="<?= set_value('nama_guru'); ?>" class="form-control" placeholder="NAMA GURU">
                                </div>
                            </div>
                            <div class="form-group row">

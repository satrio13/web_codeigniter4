            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart("backend/update-user/$data->id_user","id='form'"); ?>
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type='password' name='password' class='form-control sepasi' minlength="5" maxlength="30" placeholder='* Kosongkan jika password tidak ingin diganti.' autocomplete="off">
                                    <small class="text-danger">
                                        <?= (session()->has('validation')) ? session('validation')->getError('password') : '' ?>
                                    </small>
                                </div>
                            </div>
                            <div class="form-group row">

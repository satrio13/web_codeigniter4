            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open('backend/simpan-user','id="form-user"'); ?>
                        <?= csrf_field(); ?>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type='email' name='email' class='form-control sepasi required' placeholder='Email' value="<?= set_value('email'); ?>">
                                    <small class="text-danger">

            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart('backend/simpan-berita','id="form"'); ?>
                        <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">JUDUL BERITA <span class="text-danger">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" name="nama" maxlength="100" value="<?= set_value('nama'); ?>" class="form-control" placeholder="JUDUL BERITA" required>

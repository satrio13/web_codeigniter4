                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('backend/rekap-us'); ?>">Rekap US / UM</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open("backend/update-rekap-us/$data->id_us", 'id="form"'); ?>
                        <?= csrf_field(); ?>
                                ...
                                <div class="col-sm-5">
                                    <select name="id_kurikulum" class="form-control required">
                                        <?php foreach($mapel as $r): ?>    
                                            <option value="<?= $r->id_kurikulum; ?>" <?= ($id_kurikulum == $r->id_kurikulum) ? 'selected' : ''; ?> ><?= $r->mapel; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <small class="text-danger">

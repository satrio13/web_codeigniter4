            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart("backend/update-agenda/$data->id","id='form'"); ?>
                        <?= csrf_field(); ?>
                        <input type="hidden" name="_method" value="PUT">
                            <div class="card-body">
                                ...
                                <div class="form-group row" id="tgl_selesai" <?php if($berapa_hari == 2){ }else{ ?> style="display:none" <?php } ?> >
                                    ...
                                    <div class="col-sm-2">
                                        <input type='date' name='tgl_selesai' class='form-control' value="<?= old('tgl', $data->tgl_selesai); ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <?php }else{ ?>
                                            <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>uploads/img/agenda/<?= $data->gambar; ?>">
                                        <?php } ?>    

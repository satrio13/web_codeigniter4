            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open('backend/simpan-video','id="form"'); ?>
                        <?= csrf_field(); ?>
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">JUDUL VIDEO <span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" name="judul" maxlength="100" value="<?= set_value('judul'); ?>" class="form-control required" placeholder="JUDUL VIDEO">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="keterangan" class="form-control" maxlength="200" placeholder="KETERANGAN VIDEO"><?= set_value('keterangan'); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">KODE VIDEO DARI YOUTUBE <span class="text-danger">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" name="link" maxlength="100" value="<?= set_value('link'); ?>" class="form-control required" placeholder="KODE VIDEO DARI YOUTUBE">
                                    <small class="text-danger">

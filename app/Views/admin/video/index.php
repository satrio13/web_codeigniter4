                                    ...
                                    <?php $no = 1; foreach($data as $r): ?>
                                        <tr>
                                            ...
                                            <td class="text-center" nowrap>
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="<?= base_url("backend/hapus-video/$r->id_video"); ?>" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>

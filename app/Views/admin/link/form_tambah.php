            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open('backend/simpan-link', 'id="form"'); ?>
                        <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">NAMA HALAMAN <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" name="nama" maxlength="100" value="<?= set_value('nama'); ?>" class="form-control" placeholder="NAMA HALAMAN" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="url" name="link" value="<?= set_value('link'); ?>" class="form-control" placeholder="LINK URL" required>
                                        <small class="text-danger">

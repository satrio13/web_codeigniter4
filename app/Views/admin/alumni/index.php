                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('backend/tambah-alumni'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Alumni</a>
                                    ...
                                    <?php $no=1; foreach($data as $r): ?>
                                        <tr>
                                            ...
                                            <td class="text-center" nowrap>
                                                ...
                                                data-href="<?= base_url("backend/hapus-alumni/$r->id"); ?>" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>

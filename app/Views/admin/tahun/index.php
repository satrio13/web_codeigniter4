                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('backend/tambah-tahun'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Tahun Akademik</a>
                                    ...
                                    <?php $no = 1; foreach($data as $r): ?>
                                        <tr>
                                            ...
                                            <td class="text-center" nowrap>
                                                <a href="<?= base_url("backend/edit-tahun/$r->id_tahun"); ?>" class="btn btn-info btn-xs" title="EDIT DATA">EDIT</a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="<?= base_url("backend/hapus-tahun/$r->id_tahun"); ?>" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>

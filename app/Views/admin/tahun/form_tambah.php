            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open('backend/simpan-tahun', 'id="form"'); ?>
                        <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">TAHUN AKADEMIK <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" name="tahun" maxlength="10" value="<?= set_value('tahun'); ?>" class="form-control" placeholder="TAHUN AKADEMIK" required>

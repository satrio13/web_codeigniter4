                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url('backend/prestasi-sekolah'); ?>">Prestasi Sekolah</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart("backend/update-prestasi-sekolah/$data->id","id='form'"); ?>
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <?php }else{ ?>
                                        <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>uploads/img/prestasi/sekolah/<?= $data->gambar; ?>">
                                    <?php } ?>  

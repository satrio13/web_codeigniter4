            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open("backend/update-visi-misi","id='form'"); ?>
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?= base_url('backend/visi-misi'); ?>" class="btn btn-danger btn-sm float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                        </div>
                        <?php echo form_close() ?>
                    </div>
                    <!-- /.card -->

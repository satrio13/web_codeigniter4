            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open("backend/update-album/$data->id_album","id='form'"); ?>
                        <?= csrf_field(); ?>
                        <input type="hidden" name="_method" value="PUT">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="album" maxlength="100" value="<?= old('album', $data->album); ?>" class="form-control" placeholder="NAMA HALAMAN" required>
                                        <small class="text-danger">
                                            <?= (session()->has('validation')) ? session('validation')->getError('album') : '' ?>
                                        </small>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?= base_url('backend/album'); ?>" class="btn btn-danger btn-sm float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                            </div>
                        <?php echo form_close() ?>
                    </div>
                    <!-- /.card -->

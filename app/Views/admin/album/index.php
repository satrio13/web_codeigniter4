                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('backend/tambah-album'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Album</a>
                                    ...
                                    <?php $no = 1; foreach($data as $r): ?>
                                        <tr>
                                            ...
                                            <td class="text-center" width="10%" nowrap>
                                                <a href="<?= base_url("backend/edit-album/$r->id_album"); ?>" class="btn btn-info btn-xs" title="EDIT DATA">EDIT</a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="<?= base_url("backend/hapus-album/$r->id_album"); ?>" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>

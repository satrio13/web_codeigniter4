            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart("backend/update-prestasi-siswa/$data->id","id='form'"); ?>
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="nama_siswa" maxlength="100" value="<?= old('nama_siswa', $data->nama_siswa); ?>" class="form-control required" placeholder="NAMA SISWA">
                                    <small class="text-danger">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="kelas" maxlength="6" value="<?= old('kelas', $data->kelas); ?>" class="form-control" placeholder="KELAS">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <?php }else{ ?>
                                        <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>uploads/img/prestasi/siswa/<?= $data->gambar; ?>">
                                    <?php } ?>  

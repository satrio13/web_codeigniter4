            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart("backend/update-pengumuman/$data->id","id='form'"); ?>
                        <?= csrf_field(); ?>
                        <input type="hidden" name="_method" value="PUT">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="nama" maxlength="100" value="<?= old('nama', $data->nama); ?>" class="form-control" placeholder="NAMA PENGUMUMAN" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="textarea" name="isi" required><?= old('isi', $data->isi); ?></textarea>
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <?php }else{ ?>
                                            <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>uploads/img/pengumuman/<?= $data->gambar; ?>">
                                        <?php } ?>  

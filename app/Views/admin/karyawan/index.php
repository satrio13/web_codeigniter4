                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('backend/tambah-karyawan'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Karyawan</a>
                            ...
                            <div class="table table-responsive">
                                <table class="table table-bordered table-striped table-sm" id="datatable">
                                    ...
                                    foreach($data as $r): 
                                        ...
                                        if($r->gambar != '' AND file_exists("uploads/img/karyawan/$r->gambar"))
                                        {
                                            $img = '<a href="'.base_url("uploads/img/karyawan/$r->gambar").'" target="_blank">
                                                        <img src="'.base_url("uploads/img/karyawan/$r->gambar").'" class="img img-fluid" width="100px">
                                                    </a>'; 
                                        }else
                                        {
                                            $img = '';
                                        ...
                                        echo '<tr>
                                                ...
                                                <td class="text-center" nowrap>
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="'.base_url("backend/hapus-karyawan/$r->id").'" title="HAPUS DATA">HAPUS</a>
                                                </td>
                                            </tr>';
                                    endforeach; 
                                    ?>

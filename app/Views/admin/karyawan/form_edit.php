            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <?php echo form_open_multipart("backend/update-karyawan/$data->id",'id="form"'); ?>
                        <?= csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="tugas" maxlength="50" value="<?= old('tugas', $data->tugas); ?>" class="form-control" placeholder="TUGAS">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <?php }else{ ?>
                                        <img class='img-responsive' id='preview_gambar' width='150px' src="<?= base_url(); ?>uploads/img/karyawan/<?= $data->gambar; ?>">
                                    <?php } ?>  

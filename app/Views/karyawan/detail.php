...
<div class="container">
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('karyawan'); ?>">Tenaga Non Edukatif</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?= $title; ?></li>
            </ol>
        </nav>
    </div>
    <div class="row">
        <div class="col-md-12"><h3><b>DETAIL KARYAWAN</b></h3><hr></div>
    </div>
    <?php if($data->gambar != '' AND file_exists("uploads/img/karyawan/$data->gambar")){ ?> 
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <a href="<?= base_url("uploads/img/karyawan/$data->gambar"); ?>" class="image-link">
                    <img src="<?= base_url("uploads/img/karyawan/$data->gambar"); ?>" class="img img-fluid" width="150px">
                </a>
            </div>
        </div>
    <?php } ?>
    ...
    <div class="row">
        <div class="col-md-3"><b>TUGAS</b></div>
        <div class="col-md-9"><b>:</b> <?= $data->tugas; ?></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-7"><b>:</b> <?= $data->tingkat_pt; ?></div>
    </div>
    <div class="row">
